    ...
    <div className="flex overflow-hidden justify-around items-center gap-x-2 gap-y-2 my-2  max-md:grid max-md:auto-cols-[1fr] max-md:gap-x-2 max-md:gap-y-2 max-md:grid-cols-[1fr_1fr] max-md:grid-rows-[auto_auto]">
      {socialData.map((social) => (
        <a
          ...
          bg-opacity-40 backdrop-blur-3xl border-white bg-border-[2px] bg-border-opacity-50 bg-white hover:bg-opacity-50
          dark:bg-opacity-40 dark:backdrop-blur-3xl dark:border-black dark:bg-border-[2px] dark:bg-border-opacity-50 dark:bg-black hover:bg-opacity-50
